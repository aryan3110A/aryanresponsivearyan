  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`p-1 md:p-3 rounded-lg md:rounded-xl lg:rounded-full  transition-all duration-300 ease-in-out hover:bg-transparent transition-colors ease-in-out border border-[#8E8E8E] ${
          isOpen
