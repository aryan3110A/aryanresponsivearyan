    ...
    <>
      ...
      >        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-4 space-y-6 scrollbar-hide pb-6">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2 px-2 md:px-6 cursor-pointer" onClick={() => setIsFontOpen((v) => !v)}>
                ...
                <span className={`transition-transform ${isFontOpen ? "rotate-180" : ""}`} style={{ display: 'inline-block' }}>
                  <Image src="/BRANDINGKIT/PRODUCT_WITH_MODEL_POSE/dropdownicon.svg" alt="Dropdown" width={18} height={18} />
                </span>
              </div>
              {isFontOpen && (
            ...
            <CameraAngle onStyleSelect={props.setSelectedStyle} selectedStyle={props.selectedStyle} />
            {/* Frame Size Section */}
            ...
            <div className="mb-6 flex items-center justify-between px-2 md:px-6">
              <div className="flex items-center gap-2">
                ...
                <Image src="/BRANDINGKIT/PRODUCT_WITH_MODEL_POSE/Iicon.svg" alt="Info" width={18} height={18} />
              </div>
              <div className="flex items-center gap-2">
                <span className="flex items-center justify-center">
                  <Image src="/BRANDINGKIT/PRODUCT_WITH_MODEL_POSE/diamondicon.svg" alt="Premium" width={32} height={30} />
                </span>
                <button
                ...
                <div className="space-y-3 px-2 md:px-6">
                  ...
                  >
                    <span className="w-10 h-10 flex items-center justify-center rounded-lg bg-black/40 border border-white/10 mr-2">
                      <Image src="/BRANDINGKIT/PRODUCT_WITH_MODEL_POSE/Frame.svg" alt="Add Collection" width={24} height={24} />
                    </span>
              ...
              {isAdvanceOpen && (
                <div className="space-y-3 w-full min-w-full">
                  ...
                  <div className="flex items-center justify-between w-full bg-white/5 rounded-lg px-4 py-3">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="flex items-center justify-center">
                        <Image src="/BRANDINGKIT/PRODUCT_WITH_MODEL_POSE/diamondicon.svg" alt="Premium" width={28} height={26} />
                      </span>
                      <button
            ...
            <div className="mb-4 px-2 md:px-6">
              <button className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-white/10 hover:bg-white/20 text-white font-medium text-base transition-all"
                onClick={handleReset}>
                <Image src="/BRANDINGKIT/PRODUCT_WITH_MODEL_POSE/reply.svg" alt="Reset" width={22} height={22} />
                Reset to Defaults
              </button>
            </div>
                ...
                >
                  <div className="flex items-center justify-between w-full">
                    <span className="flex items-center gap-2">
                      <Image src="/BRANDINGKIT/PRODUCT_WITH_MODEL_POSE/stars.svg" alt="Prompt Enhance" width={22} height={22} />
