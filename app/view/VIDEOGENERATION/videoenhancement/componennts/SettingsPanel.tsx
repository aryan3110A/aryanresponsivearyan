          ...
          <div className="flex-1 overflow-y-auto px-4 space-y-6 scrollbar-hide pb-6">
            ...
            <div className="mb-6">
              <div className="bg-white/10 backdrop-blur-3xl hover:bg-white/20 rounded-lg p-4 space-y-2 text-sm text-gray-300">
                ...
                <div>Save as file : <span className="text-[#5AD7FF]">{selectedSaveAs}</span></div>
                <div>Private Mode : <span className="text-[#5AD7FF]">{privateMode ? "Enabled" : "Disabled"}</span></div>
                <div>Add collection : <span className="text-[#5AD7FF]">{collections.length > 0 ? collections.join(", ") : "None"}</span></div>
                <div>Photo Real : <span className="text-[#5AD7FF]">{photoReal ? "Enabled" : "Disabled"}</span></div>
                <div>Negative Prompt : <span className="text-[#5AD7FF]">{negativePrompt ? "Enabled" : "Disabled"}</span></div>
                <div>Tilling : <span className="text-[#5AD7FF]">{tiling ? "Enabled" : "Disabled"}</span></div>
                <div>Used fixed seed : <span className="text-[#5AD7FF]">{fixedSeed ? "Enabled" : "Disabled"}</span></div>
