...
export default function NewText2Image() {
  ...
  const buildEnhancedPrompt = (basePrompt: string, settings: SettingsData) => {
    ...
    if (settings?.visualIntensityEnabled) {
      const level =
        settings.visualIntensity > 1.5
          ? 'high detail'
          : settings.visualIntensity > 1.0
          ? 'detailed'
          : 'soft detail';
  ...
  const handleGenerate = useCallback(async () => {
    ...
    if (modelId === 6 || modelId === 7) {
      ...
      try {
        ...
        if (data.image_urls && data.image_urls.length > 0) {
          ...
          console.log(
            `🖼️ Setting generated image URL from originalImageUrl: ${data.originalImageUrl}`,
          );
    ...
    try {
      ...
      try {
        ...
        const modelEndpoint = `https://251c4e43edf3.ngrok-free.app/${modelSlug}/generate`;
    ...
    <>
      <div className="min-h-screen bg-black text-white relative overflow-hidden">
        ...
        <div className="flex w-full min-h-screen">
          <div className="md:w-auto md:max-w-[400px] lg:w-[480px] lg:max-w-[480px] h-screen overflow-y-auto scrollbar-hide border-r border-[#222] bg-transparent backdrop-blur-lg shadow-3xl z-0">
            <style jsx>{`
              .scrollbar-hide {
          ...
          <div className="flex-1 flex justify-center overflow-y-auto scrollbar-hide">
            <style jsx>{`
              .scrollbar-hide {
                -ms-overflow-style: none;
                scrollbar-width: none;
