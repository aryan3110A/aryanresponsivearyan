...
export default function Header({ 
  ...
  return (
    <header className={`w-full flex justify-center pt-8 pb-4 ${className}`}>
      <div className="w-full max-w-3xl px-2 sm:px-4 text-center">
        <h1 className="text-xl  md:text-5xl lg:text-6xl font-semibold mb-8 bg-gradient-to-r from-[#5AD7FF] to-[#656BF5] text-transparent bg-clip-text transition-colors whitespace-normal leading-relaxed">
          {title}
        </h1>
