      ...
      content: (
        <div className="w-full h-full bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-600 p-6">
          <div className="w-full h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 relative h-[300px] md:h-[400px] rounded-xl overflow-hidden">
              <Image
                src="/Landingpage/animated-tabs/imag2.png"
      ...
      content: (
        <div className="w-full h-full bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-600 p-6">
          <div className="w-full h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 relative h-[300px] md:h-[400px] rounded-xl overflow-hidden">
              <Image
                src="/Landingpage/animated-tabs/imag3.png"
      ...
      content: (
        <div className="w-full h-full bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-600 p-6">
          <div className="w-full h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 relative h-[300px] md:h-[400px] rounded-xl overflow-hidden">
              <Image
                src="/Landingpage/animated-tabs/imag4.png"
                alt="Filming Tools"
                width={400}
                height={400}
                className="w-full h-full object-cover"
      ...
      content: (
        <div className="w-full h-full bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-600 p-6">
          <div className="w-full h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 relative h-[300px] md:h-[400px] rounded-xl overflow-hidden">
              <Image
                src="/Landingpage/animated-tabs/imag5.png"
                alt="Branding Kit"
                width={400}
                height={400}
                className="w-full h-full object-cover"
      ...
      content: (
        <div className="w-full h-full bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-600 p-6">
          <div className="w-full h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 relative h-[300px] md:h-[400px] rounded-xl overflow-hidden">
              <Image
                src="/Landingpage/animated-tabs/imag6.png"
                alt="3D Generation"
                width={400}
                height={400}
                className="w-full h-full object-cover"
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="relative w-full h-[500px] md:h-[600px]">
          <Tabs
            ...
            contentClassName="h-[400px] md:h-[500px] mt-4"
          />
        </div>
      </div>
    </section>
