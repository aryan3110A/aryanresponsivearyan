    ...
    <div className="flex items-center justify-between p-2 rounded-[50px] border-[1px] border-[#b5a5a5] w-[55vw] text-white">
      ...
      <div className="relative">
        ...
        {activeDropdown === "features" && (
          <ul className="absolute left-0 mt-5 w-56 justify-center bg-black border-[0.2px] rounded-lg shadow-lg bg-transparent mt-4">
      ...
      <div className="relative">
        ...
        {activeDropdown === "templates" && (
          <ul className="absolute  left-0 mt-5 w-56 bg-black border-[0.2px] rounded-lg shadow-lg bg-transparent mt-4">
