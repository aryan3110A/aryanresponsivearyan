...
function Card({ title, description, imageSrc, scrollYProgress, index, total }: CardProps) {
  ...
  return (
    ...
    >
     <div
  className="h-full p-4 md:p-12 mb:flex-col md:flex-row flex mb:items-center mb:justify-center md:justify-start md:gap-8 mb:gap-2 gap-6 mb:px-6"
  style={{
...
>
        ...
        <div className="flex-1 mb:w-full mb:flex mb:justify-center md:items-center">
          <div className="w-full mb:w-[90%] mb:max-w-[300px] mb:aspect-square md:aspect-square rounded-2xl overflow-hidden">
