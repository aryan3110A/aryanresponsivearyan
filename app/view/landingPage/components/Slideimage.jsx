...
const SlideImage = () => {
  ...
  return (
    <div className="text-white flex w-full overflow-hidden relative mt-14 bg-black mb:items-center mb:gap-2 mb:mt-8">
  ...
  <div className="w-[40vw] overflow-hidden bg-black flex items-center justify-center mb:w-full mb:h-[150px]">
