  ...
  <div className="relative z-10 flex flex-col items-center">
    ...
    <div className="w-full max-w-[320px] space-y-8">
      <div className="text-center">
        <h2 className="text-gray-300 text-lg font-light text-[16px]">Sign up </h2>
      </div>
...
>
  Sign in
      ...
      <div className="text-center">
        <span className="text-gray-400 text-sm font-light text-[14px] -mt-10">Need an account? </span>
