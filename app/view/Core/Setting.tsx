...
const SettingNavigation: React.FC<SettingsProps> = ({ isOpen, onClose, hamburgerOpen, profiles }) => {
          ...
          <div className="mb-8">
            <div className="flex space-x-10 border-b border-gray-800 pb-3">
              <button
                ...
                className={`text-lg ${
                  activeTab === "Profile" ? "text-white border-b-2 border-blue-500" : "text-gray-400"
                }`}
              >
                Profile
              </button>
              <button
                ...
                className={`text-lg  ${
                  activeTab === "Account management" ? "text-white border-b-2 border-blue-500" : "text-gray-400"
                }`}
              >
                Account management
              </button>
          ...
          {activeTab === "Profile" && (
            <div className="">
              <div className="mb-4">
                ...
                <p className="text-[#757575] mb-2 text-md">This cannot be changed.</p>
                <input
                  type="email"
                  value="name@host.com"
                  disabled
              ...
              <div className="mb-6">
                ...
                <p className="text-[#757575] mb-2 tetx-md">Automatically saves as you change it to a valid username.</p>
                ...
                {showUsernameError && <p className="text-red-500 mt-2">Username must start with a letter and must have atleast three characters.</p>}
              </div>
                ...
                <label className="flex items-center space-x-4 cursor-pointer">
                  ...
                  <div className="pl-2">
                    <h3 className="text-md">
                      I confirm that I am over 18 and want to show explicit content by default
                    </h3>
                    <p className="text-gray-400 text-md">Automatically saves on toggle.</p>
                  </div>
                </label>
              </div>
              {/* Moved error message below the toggle div */}
              {showAgeError && (
                <p className="text-red-500 mt-2 ml-2">You must confirm you are over 18 to save changes.</p>
              )}
...
${isValid && isAgeConfirmed ? "bg-black text-blue-500 border-gray-600" : "bg-[#0B0B0B] text-[#757575] border-gray-600"}
${isValid && isAgeConfirmed ? "hover:bg-black hover:border-gray-700" : ""}`}
              >
                <FontAwesomeIcon
                  icon={faUserCheck}
                  className={`w-5 h-5 transition-all ${
                    isValid && isAgeConfirmed ? "text-blue-500" : "text-[#757575]"
                  } group-hover:text-blue-500`}
                />
                <span className="transition-all  group-hover:text-blue-500 ">Save Changes</span>
              </button>
              {/* Success message */}
              {showSuccessMessage && (
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-[#757575] mb-4 text-md">
                  Keep track of your subscription details, update your plans & billing information, and control
                  account's payment.
                </p>
                ...
                <div className="flex items-center justify-between border border-[#2D2D2D]   bg-[#171717]  rounded-full w-[70%]">
                  <div className="flex ">
                    ...
                    <div className="flex items-center px-2 py-3  rounded-lg">
                      <Image src="/navigationSetting/coins.png" alt="Credits" width={16} height={16} className="mr-2" />
                  ...
                  <button className="flex items-center  gap-2 bg-gradient-to-b from-[#5AD7FF] to-[#656BF5] px-6 py-3 rounded-full text-white">
                    <Image src="/navigationSetting/diamond.png" alt="Upgrade" width={16} height={16} />
                    Upgrade
                  </button>
                </div>
              </div>
