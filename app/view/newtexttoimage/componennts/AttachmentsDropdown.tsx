  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`p-3 rounded-xl transition-all duration-300 ease-in-out hover:bg-gradient-to-b from-[#6C3BFF] to-[#412399] transition-colors ease-in-out border border-[#8E8E8E] ${
          isOpen
      ...
      <div
        ref={dropdownRef}
        className={`absolute bottom-full left-0 mb-6 w-64 backdrop-blur-3xl bg-white/15 shadow-3xl border border-[#8E8E8E] rounded-2xl  z-50 overflow-hidden transition-all duration-300 ease-in-out transform origin-bottom ${
      ...
      >
        ...
        <div className="py-2">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-1 text-white hover:bg-gray-800/50 transition-colors duration-200"
          >
