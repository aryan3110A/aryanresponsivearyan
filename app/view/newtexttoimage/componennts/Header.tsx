    ...
    <header className="text-center py-8 lg:py-12 xl:py-16">
      <div className="flex items-center justify-center gap-4 md:gap-60 mb-6 lg:mb-8 mt-[6rem] md:mt-[10rem]">
        ...
        <div className="flex-1 max-w-4xl px-4 md:px-0">
          <h1 className="text-2xl md:text-5xl lg:text-7xl font-bold mb-4 lg:mb-6 bg-gradient-to-r from-[#5AD7FF] to-[#656BF5] text-transparent bg-clip-text transition-colors">
            Text to image with AI Art Generator
          </h1>
          <p className="text-[#A39FA8] text-sm md:text-base xl:text-lg leading-relaxed px-2 md:px-0">
